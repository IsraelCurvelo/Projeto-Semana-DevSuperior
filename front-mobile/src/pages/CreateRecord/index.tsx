...
const handleChangePlatform =(selectedPlatform: GamePlatform) =>{
  ...
  const gamesByPlataform = allGames.filter(
    game => game.platform === selectedPlatform
  )

  setFilteredGames(gamesByPlataform);
}
...
.catch(() => Alert.alert("Erro ao carregar lista de games!"));
},[]);
return(
    <>
    <Header/>
    <View style={styles.container}>
        ...
        Icon={()=> {
          return <Icon name="chevron-down" color="#00D4FF" size={25}/>
        }}
        />
